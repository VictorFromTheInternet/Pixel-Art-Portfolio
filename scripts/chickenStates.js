...
export class Idle extends State{
    constructor(chicken){
        super('chicken idle')
        this.chicken = chicken // assigning an instance of a player class
    }
    enter(){      
        this.chicken.frameX = 0  
        this.chicken.maxFrame = 3 // 4 frames
        this.chicken.frameY = 4        
...
export class Walking extends State{
    constructor(chicken){
        super('chicken walking')
        this.chicken = chicken // assigning an instance of a player class
    }
    enter(){       
        this.chicken.frameX = 0 
        this.chicken.maxFrame = 3 // 4 frames
        this.chicken.frameY = 2        
    }
    // handleInput(input){ // expects keys arr as input
